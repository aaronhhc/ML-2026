...
plt.xlabel("x")
plt.ylabel("y")
plt.title("Problem 2(b): Ridge Regression (degree=8)")
plt.legend()
plt.tight_layout()
plt.savefig("figure/p2b_ridge_curves.png", dpi=200)
plt.close()

print("Saved: figure/p2b_ridge_curves.png")

# 6. 畫 Train / Val MSE vs lambda
plt.figure(figsize=(8, 5))
plt.plot(lambdas, ridge_train_mses, marker="o", label="Train MSE")
plt.plot(lambdas, ridge_val_mses, marker="o", label="Validation MSE")
plt.xscale("log")
plt.xlabel("lambda (log scale)")
plt.ylabel("MSE")
plt.title("Problem 2(b): Ridge MSE vs Lambda")
plt.legend()
plt.tight_layout()
plt.savefig("figure/p2b_ridge_mse_vs_lambda.png", dpi=200)
plt.close()

print("Saved: figure/p2b_ridge_mse_vs_lambda.png")