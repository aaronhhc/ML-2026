...
plt.xlabel("TV")
plt.ylabel("Sales")
plt.title("Problem 3 Step 3: Ridge Regression (degree=14)")
plt.legend()
plt.tight_layout()
plt.savefig("figure/p3_step3_ridge_curves.png", dpi=200)
plt.close()

print("Saved: figure/p3_step3_ridge_curves.png")

plt.figure(figsize=(8, 5))
plt.plot(lambdas, ridge_train_mses, marker="o", label="Train MSE")
plt.plot(lambdas, ridge_test_mses, marker="o", label="Test MSE")
plt.xscale("log")
plt.xlabel("lambda (log scale)")
plt.ylabel("MSE")
plt.title("Problem 3 Step 3: Ridge MSE vs Lambda")
plt.legend()
plt.tight_layout()
plt.savefig("figure/p3_step3_ridge_mse_vs_lambda.png", dpi=200)
plt.close()

print("Saved: figure/p3_step3_ridge_mse_vs_lambda.png")